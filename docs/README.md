...
| [Open questions and gaps](reference/open-questions-and-gaps.md) | consolidated register of everything the public sources do not answer, per product, with how to close each item |
| [Vendor meeting script](reference/vendor-meeting-script.md) | platform brief (components, integration order, hardware, indicative timeline) and the question blocks to put to WALLIX: deployment model and on-premise TOTP, licensing, effort, support, integration details |
