...
| Trustelem Connect (two VMs) | on-premise RADIUS 1812 and LDAP listener for Bastion and Access Manager; SIEM push; SCIM; outbound 443 only | Bastion, Access Manager, Trustelem | [Trustelem Connect](https://trustelem-doc.wallix.com/books/trustelem-administration/page/trustelem-connect) |
