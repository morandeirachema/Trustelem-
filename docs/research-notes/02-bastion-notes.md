...
- Verified (https://www.wallix.com/support-services/alerts/): WSA-2026-07-0001 (CVSS 10, unauthenticated REST API privilege escalation, affects 12.3.0 to 12.4.0, fixed in 12.3.7 and 12.4.1, published 2026-07-20); WSA-2026-07-0002 SAML SP bypass in Access Manager fixed in 5.1.10, 5.2.7, 6.0.4; 2025-03 AD discovery credential leaks fixed in 12.0.9.
