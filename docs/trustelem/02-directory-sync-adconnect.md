...
```mermaid
flowchart LR
    CLOUD["Trustelem cloud<br/>*.trustelem.com and relay FQDNs (WSS 443)"]
    A1["Trustelem ADConnect VM 1 (priority 1)<br/>read-only AD account"]
    A2["Trustelem ADConnect VM 2 (priority 2)<br/>read-only AD account"]
